      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <Link href="/#license-types" className="text-gray-600 hover:text-blue-600 transition-colors">
              Виды лицензий
            </Link>
            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
      ...
      <section className="relative py-12 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            {/* Title */}
            <h1 className="text-4xl md:text-5xl font-bold mb-6">{license.title}</h1>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Описание деятельности</h2>
                <p className="text-gray-700 leading-relaxed text-lg">{license.fullDescription}</p>
              </div>

              {/* Requirements */}
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Лицензионные требования</h2>
                <ul className="space-y-4">
                  {license.requirements.map((req, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <div className={`flex-shrink-0 w-6 h-6 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center mt-1`}>
              ...
              {/* Process */}
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Процесс получения лицензии</h2>
                <div className="space-y-6">
                  {license.process.map((step, index) => (
                    <div key={index} className="flex items-start gap-4">
                      <div className={`flex-shrink-0 w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center font-bold text-white shadow-lg`}>
                        {index + 1}
                      </div>
              ...
              {/* Documents */}
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Необходимые документы</h2>
            ...
            <div className="space-y-6">
              {/* Contact Card */}
              <div className={`bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 text-white shadow-xl sticky top-20`}>
                ...
                <div className="space-y-4 mb-6">
                  <a href="tel:+74951234567" className="flex items-center gap-3 text-white hover:text-white/90 transition-colors">
                ...
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                      Лицензия МЧС выдается на неограниченный срок. Работать без лицензии запрещено законом и влечет административную ответственность.
                    </p>
                  </div>
                </div>
              </div>
